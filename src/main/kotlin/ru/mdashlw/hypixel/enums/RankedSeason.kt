...
/*
 TODO New leaderboards system based on https://github.com/mdashlw/hypixel-ranked-leaderboards
 */
enum class RankedSeason(val date: String, val number: Int, val leaderboard: Map<String, Pair<Int, Int>>? = null) {
    ...
    companion object {
        @JvmField
        val CURRENT_SEASON: RankedSeason = LocalDate.now().let {
            get("${it.monthValue}_${it.year.toString().drop(2)}")
        }
